...
// Was jdk.swing.interop.* (the deprecated jdk.unsupported.desktop module).
// Now our own in-module copies under com.sun.javafx.embed.swing.interop.
import com.sun.javafx.embed.swing.interop.DragSourceContextWrapper;
import com.sun.javafx.embed.swing.interop.LightweightContentWrapper;
import com.sun.javafx.embed.swing.interop.LightweightFrameWrapper;
...
public class SwingNodeInteropN {
    ...
    static {
        ...
        try {
            // Must match the relocated wrapper class. The glass native
            // _overrideNativeWindowHandle looks up the package-private
            // overrideNativeWindowHandle(long, Runnable) method on this exact
            // class via JNI, so the fully-qualified name has to be current.
            lwFrameWrapperClass = Class.forName("com.sun.javafx.embed.swing.interop.LightweightFrameWrapper");
        } catch (Throwable t) {}
