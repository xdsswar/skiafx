...
/**
 * Static helpers used by {@code JFXPanel} (FX embedded inside Swing) to reach
 * JDK-internal toolkit features: posting AWT events to the right app context,
 * window focus grab/ungrab, and {@code UngrabEvent} detection.
 *
 * <p>Verbatim port of {@code jdk.swing.interop.SwingInterOpUtils}, repackaged
...
public class SwingInterOpUtils {
    ...
    /** Posts {@code e} to the AWT app context that owns {@code target}. */
    ...
    /** Event mask the JFXPanel listener uses to observe ungrab events. */
