...
public abstract class Track
{
    ...
    public enum Encoding
    {
        ...
        H265,
        AV1,                // AV1 (Alliance for Open Media) —
                            // royalty-free codec. Each platform uses
                            // its OS-provided decoder where available:
                            // Windows: "AV1 Video Extension" (Microsoft Store, free).
                            // macOS:   VideoToolbox (Sonoma 14.4+).
                            // Linux:   system av1dec / dav1d backend.
