...
/* Opus */
/* skia-fx: upstream OpenJFX stripped the Opus helpers from the lite
 * build to save code size. Matroska demuxer (added by skia-fx) needs
 * them to construct opus caps from container codec-private bytes.
 * Re-enable the declarations here; matching implementations are
 * un-guarded in codec-utils.c. */
GST_PBUTILS_API
