...
// skia-fx: dead include "chrome/browser/ui/tab_contents/core_tab_helper.h"
// removed (no CoreTabHelper use; pulls the chrome tab-helper cone). Copied from
// chrome with this single trim — see CLAUDE.md provenance policy.
