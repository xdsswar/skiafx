...
final class WCPluginWidget extends WCWidget implements PluginListener {
    ...
    // skia-fx Blink: initIDs() bound jfxwebkit jfieldIDs (library no longer
    // loaded); calling it on class load would throw UnsatisfiedLinkError.
    // Declaration kept (unused); static initializer removed.
