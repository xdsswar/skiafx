...
public abstract class PrRenderer extends Renderer {
    ...
    public static Renderer createRenderer(FilterContext fctx) {
        // ================================================================
        // RESIZE INVARIANT #4 — paired with isEffectSupported.
        // ================================================================
        // On. Every effect renderer goes through SkiaEffectRenderer
        // (the class is named after upstream tradition but is pure
        // Skia internally — Renderer/EffectPeer abstractions kept for
        // Java API compatibility, behaviour is 100% SkImageFilter
        // chains). See SKIAPipeline.isEffectSupported.
        return com.sun.scenario.effect.impl.skia.SkiaEffectRenderer
                   .createRenderer(fctx);
    }
