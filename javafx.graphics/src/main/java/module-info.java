...
module javafx.graphics {
    ...
    exports com.sun.glass.utils to
        javafx.media,
        javafx.web,
        // openjfx-skia: javafx.scene3d reuses NativeLibLoader to extract +
        // load its own native asset lib (openjfx_model3d) from its own jar.
        javafx.scene3d;
    ...
    exports com.sun.prism to
        javafx.media,
        javafx.web;
    // openjfx-skia: exposed unqualified so sample apps can read
    // SkiaRTTexture.LAST_FPS for on-screen telemetry. Internal Prism
    // remains qualified above.
    exports com.sun.prism.skia;
